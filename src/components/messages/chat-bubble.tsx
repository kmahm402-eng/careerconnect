  ...
  return (
    <div className={`flex ${isCompany ? "justify-start" : "justify-end"} mb-4`}>
      <div className="max-w-[80%]">
        ...
        <div className={`px-4 py-3 rounded-2xl text-sm leading-relaxed ${isCompany ? "bg-card border text-foreground rounded-tl-md" : "bg-primary text-primary-foreground rounded-tr-md"}`}>{content}</div>
