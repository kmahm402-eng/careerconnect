      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-2xl">
          ...
          <button
            ...
            className="w-full py-3 bg-white border-2 border-gray-200 rounded-xl font-semibold text-gray-700 hover:bg-gray-50 transition flex items-center justify-center gap-3"
          >
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            アカウントをお持ちでない方は
            <Link href="/auth/register" className="text-brand-cta font-semibold ml-1 hover:underline">
              新規登録
            </Link>
          </p>
        </div>
